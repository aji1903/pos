...
<head>
    ...
    <link rel="stylesheet" href="/assets/tailwind-pos-main/css/style.css">
    <link rel="shortcut icon" href="/assets/tailwind-pos-main/favicon.ico" type="image/x-icon">
    ...
    <div class="hide-print flex flex-row h-screen antialiased text-blue-gray-800">
        ...
        <div class="flex-grow flex">
            ...
            <div class="flex flex-col bg-blue-gray-50 h-full w-full py-4">
                <div class="flex px-2 flex-row relative m-5">
        ...
        <div x-show="isShowModalReceipt"
            ...
            <div x-show="isShowModalReceipt" class="w-96 rounded-3xl bg-white shadow-xl overflow-hidden z-10"
                ...
                <form href ="{{ route('sale.store') }}" method='post'>
                    @csrf
